...
public class Turret4 extends Turret {
	...
	public Turret4(Model model, Projectile projectile) {
		...
		public Turret4(Model model, Projectile projectile, int x, int y, int z) {
		...
		public Turret4(Model model, Projectile projectile, int x, int y, int z, int xFireSpeed, int yFireSpeed, int zFireSpeed) {
